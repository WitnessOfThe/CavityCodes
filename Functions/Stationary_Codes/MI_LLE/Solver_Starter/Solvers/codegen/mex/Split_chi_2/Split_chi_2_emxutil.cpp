...
{
  emxFree_creal_T(&pStruct->contents);
}

void c_emxInitStruct_coder_internal_(const emlrtStack *sp, coder_internal_ref_2 *
...
void emxFreeStruct_struct2_T(struct2_T *pStruct)
{
  ...
  emxFree_creal_T(&pStruct->Psi_o_k);
  emxFree_creal_T(&pStruct->Psi_e_k);
}
  ...
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  ...
  emxInit_creal_T(sp, &pStruct->Psi_o_k, 2, srcLocation, doPush);
  emxInit_creal_T(sp, &pStruct->Psi_e_k, 2, srcLocation, doPush);
}
...
/* End of code generation (Split_chi_2_emxutil.cpp) */
