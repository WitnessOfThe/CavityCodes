 ...
 *
 * LLE_Bloch_Full_Stability_MatrixEigFAST_emxutil.c
 *
...
void emxFreeMatrix_struct8_T(struct8_T pMatrix[64])
{
  int32_T i;
  for (i = 0; i < 64; i++) {
    emxFreeStruct_struct8_T(&pMatrix[i]);
  }
}

void emxFreeStruct_struct0_T(struct0_T *pStruct)
{
  emxFreeStruct_struct7_T(&pStruct->Stab);
}

void emxFreeStruct_struct7_T(struct7_T *pStruct)
{
  emxFreeMatrix_struct8_T(pStruct->Vk);
}

void emxFreeStruct_struct8_T(struct8_T *pStruct)
{
  emxFree_creal_T(&pStruct->Vectors);
  emxFree_creal_T(&pStruct->VectorsStar);
}
  ...
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  int32_T i;
  for (i = 0; i < 64; i++) {
    emxInitStruct_struct8_T(sp, &pMatrix[i], srcLocation, doPush);
  }
}
...
void emxInitStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInitStruct_struct7_T(sp, &pStruct->Stab, srcLocation, doPush);
}

void emxInitStruct_struct7_T(const emlrtStack *sp, struct7_T *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInitMatrix_struct8_T(sp, pStruct->Vk, srcLocation, doPush);
}

void emxInitStruct_struct8_T(const emlrtStack *sp, struct8_T *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_creal_T(sp, &pStruct->Vectors, 2, srcLocation, doPush);
  emxInit_creal_T(sp, &pStruct->VectorsStar, 2, srcLocation, doPush);
}
...
/* End of code generation (LLE_Bloch_Full_Stability_MatrixEigFAST_emxutil.c) */
