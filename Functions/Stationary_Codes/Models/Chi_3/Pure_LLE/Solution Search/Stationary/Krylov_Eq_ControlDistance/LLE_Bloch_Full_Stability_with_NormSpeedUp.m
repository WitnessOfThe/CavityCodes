...
%             ValuesStartemp  = zeros(2*St.Space.N);
            ...
            Stat.Met                   = [];
            Stat.In.k                  = k(i);
            [Vectors,Valuestemp,VectorsStar,ValuesStartemp] = LLE_Bloch_StabilitySpeedUp(Stat,FF,FI);
