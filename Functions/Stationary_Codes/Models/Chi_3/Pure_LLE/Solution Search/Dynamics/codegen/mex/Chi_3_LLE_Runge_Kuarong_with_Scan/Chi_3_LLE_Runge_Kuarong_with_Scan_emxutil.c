 ...
 *
 * Chi_3_LLE_Runge_Kuarong_with_Scan_emxutil.c
 *
 * Code generation for function 'Chi_3_LLE_Runge_Kuarong_with_Scan_emxutil'
 *
 */
  ...
  *emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtCallocMex((uint32_T)i, sizeof(cuint8_T));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, sp);
    }
...
{
  emxInit_creal_T(sp, &pStruct->Psi, 2, srcLocation, doPush);
  emxInit_creal_T(sp, &pStruct->t, 2, srcLocation, doPush);
}
                      ...
                      boolean_T doPush)
{
  ...
  int32_T i;
  *pEmxArray = (emxArray_cuint8_T *)emlrtMallocMex(sizeof(emxArray_cuint8_T));
  if ((void *)*pEmxArray == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, sp);
  }
...
/* End of code generation (Chi_3_LLE_Runge_Kuarong_with_Scan_emxutil.c) */
