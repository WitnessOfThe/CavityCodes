 ...
 *
 * _coder_Chi_3_LLE_Runge_Kuarong_with_Scan_api.c
 *
 * Code generation for function '_coder_Chi_3_LLE_Runge_Kuarong_with_Scan_api'
 *
 */
...
static emlrtRTEInfo i_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_Chi_3_LLE_Runge_Kuarong_with_Scan_api",/* fName */
  ""                                   /* pName */
};
...
{
  static const int32_T dims = 0;
  static const char_T *fieldNames[7] = { "Runge_Type", "dt", "s_t", "T",
    "freq_probe", "dd", "CW_num" };
  ...
  y.T = f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "T")),
    &thisId);
  thisId.fIdentifier = "freq_probe";
  y.freq_probe = f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0,
    4, "freq_probe")), &thisId);
  thisId.fIdentifier = "dd";
  y.dd = f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "dd")),
    &thisId);
  thisId.fIdentifier = "CW_num";
  y.CW_num = f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6,
    "CW_num")), &thisId);
  emlrtDestroyArray(&u);
  return y;
}
...
void c_Chi_3_LLE_Runge_Kuarong_with_(const mxArray * const prhs[2], const
  mxArray *plhs[1])
{
  ...
  Chi_3_LLE_Runge_Kuarong_with_Scan(&st, &Temp, &Runge, &Sol);
...
/* End of code generation (_coder_Chi_3_LLE_Runge_Kuarong_with_Scan_api.c) */
