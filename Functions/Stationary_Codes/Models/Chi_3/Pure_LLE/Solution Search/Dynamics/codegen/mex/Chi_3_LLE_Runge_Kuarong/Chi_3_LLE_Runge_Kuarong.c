  ...
  struct5_T *Runge, struct6_T *Sol)
{
  ...
  while ((!exitg1) && (ni <= (int32_T)nt - 1)) {
    ...
    Psi[0].re += exp_plus_omega_contents->data[0].re * (256.0 * contents_Eq_h);
    Psi[0].im += exp_plus_omega_contents->data[0].im * (256.0 * contents_Eq_h);
    for (i = 0; i < 256; i++) {
    ...
    for (i2 = 0; i2 < i; i2++) {
      ...
      Psi[0].re += exp_plus_omega_contents->data[i2 + 1].re * (256.0 *
        contents_Eq_h);
      Psi[0].im += exp_plus_omega_contents->data[i2 + 1].im * (256.0 *
        contents_Eq_h);
    ...
    if (Temp_re == 0.0) {
      ...
      if ((10.0 * Temp_im <= -70.0) && (muDoubleScalarRem(ind_s, 2.0) == 0.0)) {
        i = r1->size[0] * r1->size[1];
        r1->size[0] = 1;
