...
static emlrtRSInfo emlrtRSI = { 31,    /* lineNo */
  ...
  "/home/dp710/GitHub/CavityCodes/Functions/Stationary_Codes/Models/Chi_3/Pure_LLE/Solution Search/Dynamics/Chi_3_LLE_Runge_Kuarong"
  ".m"                                 /* pathName */
};
...
static emlrtRTEInfo g_emlrtRTEI = { 60,/* lineNo */
  22,                                  /* colNo */
  "Chi_3_LLE_Runge_Kuarong",           /* fName */
  "/home/dp710/GitHub/CavityCodes/Functions/Stationary_Codes/Models/Chi_3/Pure_LLE/Solution Search/Dynamics/Chi_3_LLE_Runge_Kuarong"
  ".m"                                 /* pName */
...
static emlrtRTEInfo h_emlrtRTEI = { 58,/* lineNo */
  18,                                  /* colNo */
  "Chi_3_LLE_Runge_Kuarong",           /* fName */
  "/home/dp710/GitHub/CavityCodes/Functions/Stationary_Codes/Models/Chi_3/Pure_LLE/Solution Search/Dynamics/Chi_3_LLE_Runge_Kuarong"
  ".m"                                 /* pName */
...
static emlrtDCInfo u_emlrtDCI = { 64,  /* lineNo */
  55,                                  /* colNo */
  "Chi_3_LLE_Runge_Kuarong",           /* fName */
  "/home/dp710/GitHub/CavityCodes/Functions/Stationary_Codes/Models/Chi_3/Pure_LLE/Solution Search/Dynamics/Chi_3_LLE_Runge_Kuarong"
  ".m",                                /* pName */
...
static void Chi_3_LLE_Kuar_ins(const creal_T F_Psi[512], const creal_T Fac_plus
  [512], const creal_T Fac_minus[512], real_T Eq_h, const real_T Eq_gamma_Kerr
  [512], creal_T k_e[512]);
  ...
  [512], creal_T k_e[512])
{
  ...
  k_e[0].re += Fac_plus[0].re * (512.0 * Eq_h);
  k_e[0].im += Fac_plus[0].im * (512.0 * Eq_h);
}
  ...
  struct5_T *Runge, struct6_T *Sol)
{
  ...
  creal_T E_temp[512];
  int32_T d_im;
  creal_T b_exp_plus_omega_contents[512];
  creal_T b_exp_minus_omega_contents[512];
  creal_T dcv0[512];
  int32_T i2;
  int32_T i3;
  int32_T i4;
  creal_T b_E_temp[400];
  boolean_T rEQ0;
  emlrtStack st;
  st.prev = sp;
  st.tls = sp->tls;
  ...
  for (loop_ub = 0; loop_ub < 3; loop_ub++) {
    ind_s = Runge->a[loop_ub];
    for (k = 0; k < 512; k++) {
      re_tmp = 0.0 * Temp->Eq.L[k].re;
      im_tmp = 0.0 * Temp->Eq.L[k].im;
      re = dt * (ind_s * (re_tmp - (-Temp->Eq.L[k].im)));
      im = dt * (ind_s * (im_tmp + -Temp->Eq.L[k].re));
      if (im == 0.0) {
  ...
  loop_ub = (int32_T)Temp->Par.dd * 400;
  for (i0 = 0; i0 < loop_ub; i0++) {
  ...
  for (ni = 0; ni < i0; ni++) {
    ...
    for (k = 0; k < i1; k++) {
      ...
      for (loop_ub = 0; loop_ub < i2; loop_ub++) {
        ...
        if (Runge->b[(i3 + 3 * (i4 - 1)) - 1] != 0.0) {
          ind_s = dt * Runge->b[(k + 3 * loop_ub) + 1];
          i3 = b_d->size[0];
          if ((i4 < 1) || (i4 > i3)) {
          ...
          for (i3 = 0; i3 < 400; i3++) {
            ...
            if ((d_im < 1) || (d_im > 512)) {
              emlrtDynamicBoundsCheckR2012b(d_im, 1, 512, &x_emlrtBCI, &st);
            }
            ...
            if ((d_im < 1) || (d_im > 512)) {
              emlrtDynamicBoundsCheckR2012b(d_im, 1, 512, &y_emlrtBCI, &st);
            }

            b_E_temp[i3].re = E_temp[d_im - 1].re + ind_s * b_d->data[(i4 +
            ...
            if ((d_im < 1) || (d_im > 512)) {
              emlrtDynamicBoundsCheckR2012b(d_im, 1, 512, &m_emlrtBCI, &st);
            }
            ...
            if ((d_im < 1) || (d_im > 512)) {
              emlrtDynamicBoundsCheckR2012b(d_im, 1, 512, &n_emlrtBCI, &st);
            }

            b_E_temp[i3].im = E_temp[d_im - 1].im + ind_s * b_d->data[(i4 +
          ...
          for (i3 = 0; i3 < 400; i3++) {
            ...
            if ((i4 < 1) || (i4 > 512)) {
              emlrtDynamicBoundsCheckR2012b(i4, 1, 512, &p_emlrtBCI, &st);
            }
    ...
    for (k = 0; k < i1; k++) {
      ...
      if (Runge->c[i2 - 1] != 0.0) {
        ...
        for (i3 = 0; i3 < 400; i3++) {
          q = (int32_T)muDoubleScalarFloor(Temp->Eq.mode_range[i3]);
          if (Temp->Eq.mode_range[i3] != q) {
            emlrtIntegerCheckR2012b(Temp->Eq.mode_range[i3], &t_emlrtDCI, &st);
          }

          i4 = (int32_T)Temp->Eq.mode_range[i3];
          if ((i4 < 1) || (i4 > 512)) {
            emlrtDynamicBoundsCheckR2012b(i4, 1, 512, &v_emlrtBCI, &st);
          }
          ...
          if ((i4 < 1) || (i4 > 512)) {
            emlrtDynamicBoundsCheckR2012b(i4, 1, 512, &w_emlrtBCI, &st);
          }

          b_E_temp[i3].re = F_e[i4 - 1].re + ind_s * b_d->data[(i2 + b_d->size[0]
            * (i4 - 1)) - 1].re;
          if (Temp->Eq.mode_range[i3] != q) {
          ...
          if ((i4 < 1) || (i4 > 512)) {
            emlrtDynamicBoundsCheckR2012b(i4, 1, 512, &k_emlrtBCI, &st);
          }
          ...
          if ((i4 < 1) || (i4 > 512)) {
            emlrtDynamicBoundsCheckR2012b(i4, 1, 512, &l_emlrtBCI, &st);
          }

          b_E_temp[i3].im = F_e[i4 - 1].im + ind_s * b_d->data[(i2 + b_d->size[0]
            * (i4 - 1)) - 1].im;
        }

        for (i2 = 0; i2 < 400; i2++) {
          q = (int32_T)muDoubleScalarFloor(Temp->Eq.mode_range[i2]);
          if (Temp->Eq.mode_range[i2] != q) {
            emlrtIntegerCheckR2012b(Temp->Eq.mode_range[i2], &s_emlrtDCI, &st);
          }

          i3 = (int32_T)Temp->Eq.mode_range[i2];
          if ((i3 < 1) || (i3 > 512)) {
            emlrtDynamicBoundsCheckR2012b(i3, 1, 512, &u_emlrtBCI, &st);
          }
          ...
          if ((i3 < 1) || (i3 > 512)) {
            emlrtDynamicBoundsCheckR2012b(i3, 1, 512, &o_emlrtBCI, &st);
          }
    ...
    for (i1 = 0; i1 < 400; i1++) {
      ...
      if (Temp->Eq.mode_range[i1] != q) {
        emlrtIntegerCheckR2012b(Temp->Eq.mode_range[i1], &r_emlrtDCI, &st);
      }

      i2 = (int32_T)Temp->Eq.mode_range[i1];
      if ((i2 < 1) || (i2 > 512)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, 512, &s_emlrtBCI, &st);
      }
      ...
      if ((i2 < 1) || (i2 > 512)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, 512, &t_emlrtBCI, &st);
      }
    ...
    for (i1 = 0; i1 < 400; i1++) {
      ...
      i2 = (int32_T)Temp->Eq.mode_range[i1];
      if ((i2 < 1) || (i2 > 512)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, 512, &u_emlrtBCI, &st);
      }
      ...
      if ((i2 < 1) || (i2 > 512)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, 512, &j_emlrtBCI, &st);
      }
    ...
    if (r == 0.0) {
      ...
      for (i1 = 0; i1 < 400; i1++) {
        ...
        i2 = (int32_T)Temp->Eq.mode_range[i1];
        if ((i2 < 1) || (i2 > 512)) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, 512, &q_emlrtBCI, sp);
        }
      }
      ...
      for (i1 = 0; i1 < 400; i1++) {
        q = F_e[(int32_T)Temp->Eq.mode_range[i1] - 1].re;
        re_tmp = F_e[(int32_T)Temp->Eq.mode_range[i1] - 1].im;
        if (re_tmp == 0.0) {
          Sol->Psi->data[((int32_T)ind_s + Sol->Psi->size[0] * i1) - 1].re = q /
            Temp->Space.N;
          Sol->Psi->data[((int32_T)ind_s + Sol->Psi->size[0] * i1) - 1].im = 0.0;
        } else if (q == 0.0) {
          Sol->Psi->data[((int32_T)ind_s + Sol->Psi->size[0] * i1) - 1].re = 0.0;
          Sol->Psi->data[((int32_T)ind_s + Sol->Psi->size[0] * i1) - 1].im =
            re_tmp / Temp->Space.N;
        } else {
          Sol->Psi->data[(i2 + Sol->Psi->size[0] * i1) - 1].re = q /
            Temp->Space.N;
          Sol->Psi->data[((int32_T)ind_s + Sol->Psi->size[0] * i1) - 1].im =
            re_tmp / Temp->Space.N;
        }
