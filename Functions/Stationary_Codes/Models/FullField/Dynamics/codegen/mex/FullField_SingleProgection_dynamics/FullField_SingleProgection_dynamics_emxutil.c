 ...
 *
 * FullField_SingleProgection_dynamics_emxutil.c
 *
...
{
  emxFree_creal_T(sp, &pStruct->Psi);
  emxFree_creal_T(sp, &pStruct->t);
  emxFree_creal_T(sp, &pStruct->PsiReal);
  emxFree_real_T(sp, &pStruct->G);
}
...
void emxInitStruct_captured_var(const emlrtStack *sp, e_captured_var *pStruct,
                                const emlrtRTEInfo *srcLocation)
{
  emxInit_creal_T(sp, &pStruct->contents, srcLocation);
}

void emxInitStruct_captured_var1(const emlrtStack *sp, f_captured_var *pStruct,
                                 const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->contents, srcLocation);
}

void emxInitStruct_struct8_T(const emlrtStack *sp, struct8_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_creal_T(sp, &pStruct->Psi, srcLocation);
  emxInit_creal_T(sp, &pStruct->t, srcLocation);
  emxInit_creal_T(sp, &pStruct->PsiReal, srcLocation);
  emxInit_real_T(sp, &pStruct->G, srcLocation);
}
...
/* End of code generation (FullField_SingleProgection_dynamics_emxutil.c) */
