...
%    coder.gpu.kernelfun;
 %   coder.gpu.kernel;
    ...
    d(1,:) =   Chi_3_LLE_Kuar_ins(E_temp,exp_plus_omega(1,:),exp_minus_omega(1,:),gam2o,gam2e,gam3o,gam3e,H_f);
    ...
    for i2 = 2:Runge.s
        ...
        d(i2,:) =   Chi_3_LLE_Kuar_ins(E_temp,exp_plus_omega(i2,:),exp_minus_omega(i2,:),gam2o,gam2e,gam3o,gam3e,H_f);            
