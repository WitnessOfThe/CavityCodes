  ...
  emlrtMsgIdentifier *parentId, struct2_T *y)
{
  ...
  static const char_T *fieldNames[28] = { "eta", "ko", "ke", "gam2o", "gam2e",
    ...
    "Ws_Star", "Omega_Star", "eps", "delta_o", "N", "W", "mu_bl", "delta_e",
    "H_f", "H_s", "Omega_f", "Omega_s", "d", "Psi_Start", "t_start" };
  ...
  y->W = f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 18, "W")),
    &thisId);
  ...
  y->d = f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 25, "d")),
    &thisId);
  ...
  emlrtMsgIdentifier *parentId, struct4_T *y)
{
  ...
  n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 16, "Lo")),
                     &thisId, y->Lo);
  thisId.fIdentifier = "Le";
  n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 17, "Le")),
                     &thisId, y->Le);
  thisId.fIdentifier = "L";
  o_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 18, "L")),
                     &thisId, y->L);
  emlrtDestroyArray(&u);
}
