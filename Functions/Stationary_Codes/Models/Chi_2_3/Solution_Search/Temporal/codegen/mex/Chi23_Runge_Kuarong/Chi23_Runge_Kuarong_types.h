...
#ifndef typedef_b_Chi23_Runge_Kuarong
#define typedef_b_Chi23_Runge_Kuarong
typedef struct {
  creal_T exp_minus_omega_contents[6144];
  creal_T exp_plus_omega_contents[6144];
  creal_T y[2048];
} b_Chi23_Runge_Kuarong;
#endif /* typedef_b_Chi23_Runge_Kuarong */
...
typedef struct {
  b_Chi23_Runge_Kuarong f0;
  b_Chi23_Runge_Kuarong_api f1;
