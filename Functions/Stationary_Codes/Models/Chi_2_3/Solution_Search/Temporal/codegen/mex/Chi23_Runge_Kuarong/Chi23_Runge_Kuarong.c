  ...
  struct5_T *Runge, struct6_T *Sol)
{
  ...
  if (0 <= i - 1) {
    ...
    im = 256.0 * exp_plus_omega_contents[0].im;
    if (im == 0.0) {
      b_re = q / 2.0;
      b_im = 0.0;
    } else if (q == 0.0) {
  ...
  for (ni = 0; ni < i; ni++) {
    ...
    for (i3 = 0; i3 < 256; i3++) {
      ...
      b_d = z1[i3].re;
      d4 = z1[i3].im;
      k_e[i3 + 256].re = re * b_d - im * d4;
      k_e[i3 + 256].im = re * d4 + im * b_d;
    }
    ...
    for (b_i2 = 0; b_i2 < i1; b_i2++) {
      ...
      for (loop_ub = 0; loop_ub < i5; loop_ub++) {
        ...
        if (b_d != 0.0) {
          ...
          for (i3 = 0; i3 < 512; i3++) {
            ...
            b_i = (int32_T)b_d;
            if ((b_i < 1) || (b_i > 512)) {
              emlrtDynamicBoundsCheckR2012b(b_i, 1, 512, &p_emlrtBCI, &st);
            }
      ...
      im = 256.0 * exp_plus_omega_contents[b_i2 + 1].im;
      if (im == 0.0) {
        re = q / 2.0;
        im = 0.0;
      } else if (q == 0.0) {
    ...
    for (loop_ub = 0; loop_ub < i2; loop_ub++) {
      ...
      if (b_d != 0.0) {
        ...
        for (i3 = 0; i3 < 512; i3++) {
          ...
          b_i = (int32_T)b_d;
          if ((b_i < 1) || (b_i > 512)) {
            emlrtDynamicBoundsCheckR2012b(b_i, 1, 512, &r_emlrtBCI, &st);
          }
    ...
    for (i3 = 0; i3 < 512; i3++) {
      ...
      b_i = (int32_T)b_d;
      if ((b_i < 1) || (b_i > 512)) {
        emlrtDynamicBoundsCheckR2012b(b_i, 1, 512, &m_emlrtBCI, &st);
      }
    ...
    if (r == 0.0) {
      ...
      if (Temp->Space.N + 1.0 > d1) {
        ...
        if (((int32_T)d1 < 1) || ((int32_T)d1 > 512)) {
          emlrtDynamicBoundsCheckR2012b((int32_T)d1, 1, 512, &h_emlrtBCI, sp);
        }
