 ...
 *
 * Code generation for function 'Chi23OPO_Runge_Kuarong_emxutil'
 *
 */
...
{
  emxInit_creal_T(sp, &pStruct->Psio, 2, srcLocation, doPush);
  emxInit_creal_T(sp, &pStruct->Psie, 2, srcLocation, doPush);
...
/* End of code generation (Chi23OPO_Runge_Kuarong_emxutil.c) */
