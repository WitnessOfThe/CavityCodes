  ...
  struct5_T *Runge, struct6_T *Sol)
{
  ...
  if (0 <= i - 1) {
    q = 256.0 * exp_plus_omega_contents[768].re;
  ...
  for (ni = 0; ni < i; ni++) {
    ...
    k_e[256].re += Temp->Eq.ke * b_re * Temp->Eq.H_s;
    k_e[256].im += Temp->Eq.ke * b_im * Temp->Eq.H_s;
    ...
    for (b_i2 = 0; b_i2 < i1; b_i2++) {
      ...
      q = 256.0 * exp_plus_omega_contents[b_i2 + 769].re;
      ...
      k_e[256].re += Temp->Eq.ke * re * Temp->Eq.H_s;
