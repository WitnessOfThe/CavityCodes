...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        L1      = ( xo.*(Stat.Eq.Lo + 1/2*Stat.In.n^2*Stat.Eq.Do(2)+Stat.In.n*Stat.Eq.Do(2)*Stat.Space.k - V*(Stat.Space.k+Stat.In.n)) );
        ...
        L2      =  xe.*(Stat.Eq.Le+Stat.Eq.d*Stat.In.n + 1/2*Stat.In.n^2*Stat.Eq.De(2) + ...
            Stat.In.n*Stat.Eq.De(2)*Stat.Space.k  - V*(Stat.Space.k+Stat.In.n));
