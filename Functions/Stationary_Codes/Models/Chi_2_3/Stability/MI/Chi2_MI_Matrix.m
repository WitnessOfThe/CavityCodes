function  M = Chi2_MI_Matrix(CW,i,j)
    ...
    g_1_1 = CW.Space.k(i).^2*CW.Eq.Do(2)/2-1/2*CW.Eq.ko+CW.Eq.delta_o;
    g_1_2 = -sqrt(2*CW.Eq.gam2o*CW.Eq.gam2e)*Psi_o; 
    g_1_3 = -CW.Eq.gam2o*conj(Psi_e); 
    g_1_4 = 0; 
    
    g_2_1 = -sqrt(2*CW.Eq.gam2o*CW.Eq.gam2e)*conj(Psi_o);
    g_2_2 = CW.Space.k(i)*CW.Eq.d+CW.Space.k(i).^2*CW.Eq.De(2)/2-1/2*CW.Eq.ke+CW.Eq.delta_e; 
    g_2_3 = 0; 
    g_2_4 = 0; 
    
    g_3_1 = CW.Eq.gam2o*(Psi_e);
    g_3_2 = 0; 
    g_3_3 = -CW.Space.k(i).^2*CW.Eq.Do(2)/2-1/2*CW.Eq.ko-CW.Eq.delta_o; 
    g_3_4 = sqrt(2*CW.Eq.gam2o*CW.Eq.gam2e)*conj(Psi_o); 

    g_4_1 = 0;
    g_4_2 = 0; 
    g_4_3 = sqrt(2*CW.Eq.gam2o*CW.Eq.gam2e)*(Psi_o); 
    g_4_4 = CW.Space.k(i)*CW.Eq.d-CW.Space.k(i).^2*CW.Eq.De(2)/2-1/2*CW.Eq.ke-CW.Eq.delta_e; 
