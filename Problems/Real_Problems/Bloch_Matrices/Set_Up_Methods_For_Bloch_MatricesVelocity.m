function Res = Set_Up_Methods_For_Bloch_MatricesVelocity
  ...
  %@LLE_Zero_Velocity_Equation_Turndelta
% 
...
%    Res.Stat.Met.Preconditioner        = @LLE_Zero_Velocity_Predonditioner;
    ...
    Res.Stat.Met.Equation_Mod             = @LLE_Full_Dispersion_Equation_Turndelta;
    Res.Stat.Met.Liniar_Decomposition_Mod = @LLE_Full_Dispersion_Linear_Decomposition_TurnDelta;
    Res.Stat.Met.Preconditioner_Mod       = @LLE_Full_Dispersion_Predonditioner_TurnDelta;
