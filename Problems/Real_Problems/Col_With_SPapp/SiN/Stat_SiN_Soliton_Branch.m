...
%    L_L.CW.In.D        =2*pi*[1E12,20E6,0,-117.5E3,-5.3E3,-150];
    L_L.CW.In.D               = 2*pi*[1E12,20E6,0,-115.5E3,-5.3E3,-150];% Dispersion Coefficients,-4E3
    SiN.Stat.In.kappa   = 150E6*2*pi;                
    SiN.Stat.In.P       = 0.04648;
    SiN.Stat.In.delta   = 2.18*SiN.Stat.In.kappa;
...
%     SiN.Stat.Par.top_boundary     = 1;
    ...
    SiN.Stat.Par.first_step       = 0.0001; % step for delta measured in delta/kappa
    SiN.Stat.Par.step_tol         = 0.00001;

    SiN.Stat.Par.bot_boundary     = 0;
    SiN.Stat.Par.top_boundary     = 2.4;
...
figure;
plot(real(lambda_vector_U));hold on;%delta_vector_U,
% figure;
