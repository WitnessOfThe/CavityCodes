...
%%
    ...
    Res.CW.Par.bot_boundary     = -20; % bottom boundary for delta to search
    Res.CW.Par.top_boundary     =  21; % top boundary for delta to search
  ...
  %%
    ...
    Sa2.U_f_23   =   zeros(NN,3);
    Sa2.U_s_23   =   zeros(NN,3);
