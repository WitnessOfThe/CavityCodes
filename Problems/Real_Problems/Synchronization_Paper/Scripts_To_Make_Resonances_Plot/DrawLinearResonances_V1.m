...
for i = Numbers(1:end)
    ...
    tt_4 = tt_4.changeFigOptions('Height',7.5/2,...
                     'Width',18/2);
    tt_4 = tt_4.addData([-0.5,1.44,0,0], [], [], 'PlotType', 'Annotation', 'AnnotationType', 'textbox', 'String', '$|\mu|=4$','FontSize',14);
    tt_4 = tt_4.addData([-0.33,1.44,0,0], [], [], 'PlotType', 'Annotation', 'AnnotationType', 'textbox', 'String', '$|\mu|=3$','FontSize',14);
    tt_4 = tt_4.addData([-0.19,1.44,0,0], [], [], 'PlotType', 'Annotation', 'AnnotationType', 'textbox', 'String', '$|\mu|=2$','FontSize',14);
    tt_4 = tt_4.addData([-0.05,1.44,0,0], [], [], 'PlotType', 'Annotation', 'AnnotationType', 'textbox', 'String', '$|\mu|=1$','FontSize',14);
...
for i = Numbers(1:end)
    ...
    tt_5 = tt_5.changeFigOptions('Height',7.5/2,...
                     'Width',18/2);
    tt_5 = tt_5.addData([0.34,1.45,0,0], [], [], 'PlotType', 'Annotation', 'AnnotationType', 'textbox', 'String', '$|\mu|=4$','FontSize',14);
    tt_5 = tt_5.addData([0.19,1.45,0,0], [], [], 'PlotType', 'Annotation', 'AnnotationType', 'textbox', 'String', '$|\mu|=3$','FontSize',14);
    tt_5 = tt_5.addData([0.05,1.45,0,0], [], [], 'PlotType', 'Annotation', 'AnnotationType', 'textbox', 'String', '$|\mu|=2$','FontSize',14);
    tt_5 = tt_5.addData([-0.1,1.45,0,0], [], [], 'PlotType', 'Annotation', 'AnnotationType', 'textbox', 'String', '$|\mu|=1$','FontSize',14);
    tt_5 = tt_5.addData([-0.18,1,0,0], [], [], 'PlotType', 'Annotation', 'AnnotationType', 'textbox', 'String', '$\mu=0$','FontSize',14);
...
tt_2.plotData
figure;
cf_1 = conFigure([tt_4,tt_6,tt_5,tt_6], 2,2,'Labels',false, 'UniformPlots', true,'Units','centimeters', 'Height', 7, 'Width', 18,'separation', 3);
