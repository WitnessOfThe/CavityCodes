...
%% Input Parameters for SiN
    ...
    SiN.Temp.In.delta   = -2.3e+09*2*pi;    
    SiN.Temp.In.P       = 0.9;      
    
%%
    SiN.Temp.Par.Runge_Type    = 'Runge SSPRK3';    
    SiN.Temp.Par.dt            = 0.1E-2;
...
%%
    SiN.Temp.Met.Plot.Carpets(SiN.Temp)
%%
    SiN.CW.Met.Plot.Dressed_State(SiN.CW,1)
   Plot_Dynamics_Rf_Spectrums_mu(SiN.Temp,20001:25000)
%%
    Plot_Dynamics_Rf_Spectrums(SiN.Temp,[-10,10],2001:25000)
