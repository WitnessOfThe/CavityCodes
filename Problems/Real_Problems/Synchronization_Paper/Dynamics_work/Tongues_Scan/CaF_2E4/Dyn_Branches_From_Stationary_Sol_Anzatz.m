...
%% Input Parameters for CaF
    ...
    CaF.Temp            = CaF.Stat;
    CaF.Temp.Met.Ev_Start_Point  = @Chi_3_LLE_Start_Point_Stat_Envelope_Soliton;
...
%%
  Path = strcat('C:/Users/dp710/Documents/Data_Storage/From_Turing_Based_Anzatz_CaF_mu=',num2str(mu),'_',num2str(CaF.Stat(1).In.D(2)/CaF.Stat(1).In.kappa),'_Upper_Branch_Scan_',CaF.Stat.Par.variable ,'_Start_delta=',num2str(CaF.Stat(1).In.delta/CaF.Stat(1).In.kappa),'_Power=',num2str(CaF.Stat(1).In.P));
  delete(gcp('nocreate'));
  parpool(6);
  %%
