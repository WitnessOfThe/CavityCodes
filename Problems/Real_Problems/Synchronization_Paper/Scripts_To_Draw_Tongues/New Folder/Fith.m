...
%% Input Parameters for CaF
    ...
    L_L.In         = Params_CaF;
    L_L.In.kappa   =  2*1E4*2*pi;%2*1E3*2*pi;%
...
%save('X:\Documents\MATLAB\Matlab_Repo\Problems\Cavity_Codes\Problems\Real_Problems\Synchronization_Paper\Scripts_To_Draw_Tongues\New Folder\Fith.mat','pp4');
