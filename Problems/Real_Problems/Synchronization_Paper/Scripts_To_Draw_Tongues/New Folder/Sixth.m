...
pp4 = pp4.changeAxisOptions('XLabelText', '',...
                            'YLabelText', '','YLim',[-0.01,0.6],'FontSize',14,'XLim',[-0.62,0]);
...
save('X:\Documents\MATLAB\Matlab_Repo\Problems\Cavity_Codes\Problems\Real_Problems\Synchronization_Paper\Scripts_To_Draw_Tongues\New Folder\Sixth.mat','pp4');
