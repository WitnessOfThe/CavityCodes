function Chi_3_LLE_Runge_Save_Long_Run(Path,CaF,Ind,mu)

    for i = 1:length(mu)
        
        SaveInd(i)               = find (CaF.Temp.Space.k(CaF.Temp.Eq.mode_range) == mu(i));
    ...
    CF = conFigure([tt_1,tt_2,tt_3,tt_4],2,2, 'UniformPlots', true, 'Height', 18, 'Width', 18,'Labels',false);
    h = gcf;
