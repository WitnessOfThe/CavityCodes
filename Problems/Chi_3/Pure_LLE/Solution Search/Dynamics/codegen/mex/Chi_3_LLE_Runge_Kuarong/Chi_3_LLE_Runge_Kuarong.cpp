...
static void Chi_3_LLE_Kuar_ins(const creal_T F_Psi[2048], const creal_T
  Fac_plus[2048], const creal_T Fac_minus[2048], real_T Eq_h, const real_T
  Eq_gamma_Kerr[2048], creal_T k_e[2048]);
  ...
  Eq_gamma_Kerr[2048], creal_T k_e[2048])
{
  ...
  k_e[0].re += (0.0 * Fac_plus[0].re - Fac_plus[0].im) * (2048.0 * Eq_h);
  k_e[0].im += (0.0 * Fac_plus[0].im + Fac_plus[0].re) * (2048.0 * Eq_h);
}

void Chi_3_LLE_Runge_Kuarong(c_Chi_3_LLE_Runge_KuarongStackD *SD, const
  emlrtStack *sp, const struct0_T *Temp, real_T, const struct5_T *Runge,
  struct6_T *Sol)
{
  emxArray_cuint8_T *d;
  int32_T i0;
  ...
  for (loop_ub = 0; loop_ub < 3; loop_ub++) {
    ...
    for (k = 0; k < 2048; k++) {
      ...
      i0 = loop_ub + 3 * k;
      SD->f0.exp_minus_omega_contents[i0].re = re;
      SD->f0.exp_minus_omega_contents[i0].im = im;
      re = dt * (q * (re_tmp - Temp->Eq.L[k].im));
      im = dt * (q * (im_tmp + Temp->Eq.L[k].re));
      SD->f0.y[k].re = re;
      SD->f0.y[k].im = im;
      ...
      SD->f0.exp_plus_omega_contents[i0].re = re;
      SD->f0.exp_plus_omega_contents[i0].im = im;
    }
  ...
  for (k = 0; k < 2048; k++) {
    ...
    SD->f0.F_e[k] = Temp->In.Psi_Start[k];
  }
  ...
  loop_ub = (int32_T)Temp->Par.dd * 700;
  for (i0 = 0; i0 < loop_ub; i0++) {
  ...
  for (ni = 0; ni < i0; ni++) {
    ...
    /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
    memcpy(&SD->f0.E_temp[0], &SD->f0.F_e[0], sizeof(creal_T) << 11);
    i1 = d->size[0];
    if (1 > i1) {
    ...
    for (i1 = 0; i1 < 2048; i1++) {
      SD->f0.b_exp_plus_omega_contents[i1] = SD->f0.exp_plus_omega_contents[3 *
        i1];
      SD->f0.b_exp_minus_omega_contents[i1] = SD->f0.exp_minus_omega_contents[3 *
        i1];
    }

    Chi_3_LLE_Kuar_ins(SD->f0.F_e, SD->f0.b_exp_plus_omega_contents,
                       SD->f0.b_exp_minus_omega_contents, Temp->Eq.h,
    ...
    for (k = 0; k < i1; k++) {
      ...
      for (loop_ub = 0; loop_ub < i2; loop_ub++) {
        ...
        if (Runge->b[(i3 + 3 * (i4 - 1)) - 1] != 0.0) {
          ...
          for (i3 = 0; i3 < 700; i3++) {
            ...
            if ((d_im < 1) || (d_im > 2048)) {
              emlrtDynamicBoundsCheckR2012b(d_im, 1, 2048, &x_emlrtBCI, &st);
            }
            ...
            if ((d_im < 1) || (d_im > 2048)) {
              emlrtDynamicBoundsCheckR2012b(d_im, 1, 2048, &y_emlrtBCI, &st);
            }

            E_temp[i3].re = SD->f0.E_temp[d_im - 1].re + nt * b_d->data[(i4 +
            ...
            if ((d_im < 1) || (d_im > 2048)) {
              emlrtDynamicBoundsCheckR2012b(d_im, 1, 2048, &m_emlrtBCI, &st);
            }
            ...
            if ((d_im < 1) || (d_im > 2048)) {
              emlrtDynamicBoundsCheckR2012b(d_im, 1, 2048, &n_emlrtBCI, &st);
            }

            E_temp[i3].im = SD->f0.E_temp[d_im - 1].im + nt * b_d->data[(i4 +
          ...
          for (i3 = 0; i3 < 700; i3++) {
            ...
            if ((i4 < 1) || (i4 > 2048)) {
              emlrtDynamicBoundsCheckR2012b(i4, 1, 2048, &p_emlrtBCI, &st);
            }

            SD->f0.E_temp[i4 - 1].re = E_temp[i3].re;
            if (Temp->Eq.mode_range[i3] != re_tmp) {
              emlrtIntegerCheckR2012b(Temp->Eq.mode_range[i3], &p_emlrtDCI, &st);
            }
            ...
            SD->f0.E_temp[i4 - 1].im = E_temp[i3].im;
          }
        }
      ...
      for (i2 = 0; i2 < 2048; i2++) {
        SD->f0.b_exp_plus_omega_contents[i2] = SD->f0.exp_plus_omega_contents[(k
          + 3 * i2) + 1];
      }
      ...
      for (i2 = 0; i2 < 2048; i2++) {
        SD->f0.b_exp_minus_omega_contents[i2] = SD->f0.exp_minus_omega_contents
          [(k + 3 * i2) + 1];
      }

      Chi_3_LLE_Kuar_ins(SD->f0.E_temp, SD->f0.b_exp_plus_omega_contents,
                         SD->f0.b_exp_minus_omega_contents, Temp->Eq.h,
                         Temp->Eq.gamma_Kerr, dcv0);
      i2 = b_d->size[0];
      i3 = (int32_T)(2U + k);
    ...
    for (k = 0; k < i1; k++) {
      ...
      if (Runge->c[i2 - 1] != 0.0) {
        ...
        for (i3 = 0; i3 < 700; i3++) {
          ...
          i4 = (int32_T)Temp->Eq.mode_range[i3];
          if ((i4 < 1) || (i4 > 2048)) {
            emlrtDynamicBoundsCheckR2012b(i4, 1, 2048, &v_emlrtBCI, &st);
          }
          ...
          if ((i4 < 1) || (i4 > 2048)) {
            emlrtDynamicBoundsCheckR2012b(i4, 1, 2048, &w_emlrtBCI, &st);
          }

          E_temp[i3].re = SD->f0.F_e[i4 - 1].re + nt * b_d->data[(i2 + b_d->
            size[0] * (i4 - 1)) - 1].re;
          if (Temp->Eq.mode_range[i3] != re_tmp) {
          ...
          if ((i4 < 1) || (i4 > 2048)) {
            emlrtDynamicBoundsCheckR2012b(i4, 1, 2048, &k_emlrtBCI, &st);
          }
          ...
          if ((i4 < 1) || (i4 > 2048)) {
            emlrtDynamicBoundsCheckR2012b(i4, 1, 2048, &l_emlrtBCI, &st);
          }

          E_temp[i3].im = SD->f0.F_e[i4 - 1].im + nt * b_d->data[(i2 + b_d->
            size[0] * (i4 - 1)) - 1].im;
        }
        ...
        for (i2 = 0; i2 < 700; i2++) {
          ...
          if ((i3 < 1) || (i3 > 2048)) {
            emlrtDynamicBoundsCheckR2012b(i3, 1, 2048, &u_emlrtBCI, &st);
          }

          SD->f0.F_e[i3 - 1].re = E_temp[i2].re;
          if (Temp->Eq.mode_range[i2] != re_tmp) {
            emlrtIntegerCheckR2012b(Temp->Eq.mode_range[i2], &o_emlrtDCI, &st);
          }

          if ((i3 < 1) || (i3 > 2048)) {
            emlrtDynamicBoundsCheckR2012b(i3, 1, 2048, &o_emlrtBCI, &st);
          }

          SD->f0.F_e[i3 - 1].im = E_temp[i2].im;
        }
      }
    ...
    for (i1 = 0; i1 < 700; i1++) {
      ...
      if ((i2 < 1) || (i2 > 2048)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, 2048, &s_emlrtBCI, &st);
      }
      ...
      if ((i2 < 1) || (i2 > 2048)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, 2048, &t_emlrtBCI, &st);
      }
      ...
      E_temp[i1].re = SD->f0.y[i2 - 1].re * SD->f0.F_e[i2 - 1].re - SD->f0.y[i2
        - 1].im * SD->f0.F_e[i2 - 1].im;
      if (Temp->Eq.mode_range[i1] != re_tmp) {
        emlrtIntegerCheckR2012b(Temp->Eq.mode_range[i1], &s_emlrtDCI, &st);
      }
      ...
      E_temp[i1].im = SD->f0.y[i2 - 1].re * SD->f0.F_e[i2 - 1].im + SD->f0.y[i2
        - 1].im * SD->f0.F_e[i2 - 1].re;
    }
    ...
    for (i1 = 0; i1 < 700; i1++) {
      ...
      i2 = (int32_T)Temp->Eq.mode_range[i1];
      if ((i2 < 1) || (i2 > 2048)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, 2048, &u_emlrtBCI, &st);
      }

      SD->f0.F_e[i2 - 1].re = E_temp[i1].re;
      if (Temp->Eq.mode_range[i1] != re_tmp) {
        emlrtIntegerCheckR2012b(Temp->Eq.mode_range[i1], &j_emlrtDCI, &st);
      }

      if ((i2 < 1) || (i2 > 2048)) {
        emlrtDynamicBoundsCheckR2012b(i2, 1, 2048, &j_emlrtBCI, &st);
      }

      SD->f0.F_e[i2 - 1].im = E_temp[i1].im;
    }
    ...
    if (r == 0.0) {
      ...
      for (i1 = 0; i1 < 700; i1++) {
        ...
        i2 = (int32_T)Temp->Eq.mode_range[i1];
        if ((i2 < 1) || (i2 > 2048)) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, 2048, &q_emlrtBCI, sp);
        }
      }
      ...
      for (i1 = 0; i1 < 700; i1++) {
        nt = SD->f0.F_e[(int32_T)Temp->Eq.mode_range[i1] - 1].re;
        q = SD->f0.F_e[(int32_T)Temp->Eq.mode_range[i1] - 1].im;
        if (q == 0.0) {
