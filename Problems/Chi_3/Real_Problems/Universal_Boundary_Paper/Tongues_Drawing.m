...
%% Define Input Parameters in Physical Units
    ...
    L_L.In.kappa           = 4.188790204786391e+03;         % LineWidth 
...
%%
    N = 200000;   
    delta_vector  = linspace(-0.6125,-0.611,N);
    
    Mode     = 35;
    ind_Mode = find(L_L.Space.k == Mode);

    W_MI_vector_1 = zeros(N,1);
    W_MI_vector_2 = zeros(N,1);
    W_Synch_vector_1 = zeros(N,1);
    W_Synch_vector_2 = zeros(N,1);
    Real_1          = zeros(N,1);
    Imag_1          = zeros(N,1);
    Imag_2          = zeros(N,1);
...
figure;
plot(delta_vector,W_MI_vector_1(:,1))

hold on;
plot(delta_vector,W_MI_vector_2(:,1))

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

plot(delta_vector,W_Synch_vector_1(:,1))
hold on;
plot(delta_vector,W_Synch_vector_2(:,1))
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    L_L.In.P               = 0.025;
    N = 1000;   
    delta_vector  = linspace(-0.6126,-0.611,N)*2*pi*1E6;
